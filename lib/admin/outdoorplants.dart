...
import 'package:plantium/admin/addoutdoor.dart';
              ...
              Center(
                child: Container(
                  ...
                  child: TextField(
                    ...
                    onChanged: (item){
                      mainProvider.searchOutdoor(item);
                    },
                  ),),
              ),
              SizedBox(
                                                      ...
                                                      Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                                                          children: [
                                                            TextButton(
                                                              onPressed: () {
                                                                finish(context);
                                                                value.getEditoudoor(value.OutdoorList[index].Ouid);
                                                                callNext(context, AddOutdoor(
                                                                  Outfrom: "Edit",
                                                                  OutId: value.OutdoorList[index].Ouid,));
                                                              },
                                                            ...
                                                            TextButton(
                                                              onPressed: () {
                                                                value.getDeleteoutdoor(context,
                                                                    value.OutdoorList[index].Ouid);
                                                                finish(context);
                                                              },
